...
[![x-cmd/install — mongosh Code Quality Monitoring Repo Card](https://repo.x-cmd.io/mongosh.svg?lang=zh)](https://x-cmd.com/install/mongosh)
...
合计: **179,731** 行代码（覆盖前 5 种语言、共 **761** 个文件）。
...
- **发布数**: 151 · **已合并 PR**: 2656 · **开放 PR**: 25 · **已关闭 issue**: 0 · **开放 issue**: 0 · **提交数**: 4549
