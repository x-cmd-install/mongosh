...
![mongosh](https://repo.x-cmd.io/mongosh.svg?lang=zh)
...
合计: **177,682** 行代码（覆盖前 5 种语言、共 **762** 个文件）。
...
- **Star**: 403 · **Fork**: 93 · **开放 issue**: 0 · **贡献者**: 78

## 累计统计

- **发布数**: 150 · **已合并 PR**: 2654 · **开放 PR**: 27 · **已关闭 issue**: 0 · **开放 issue**: 0 · **提交数**: 4541

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-18 | 1 | 23 | 6 | 0 | 0 | 44 |
| last60d | 2026-07-19 | 2 | 49 | 18 | 0 | 0 | 94 |
| 90d | 2026-06-19 | 5 | 75 | 19 | 0 | 0 | 157 |
| last180d | 2026-03-21 | 7 | 116 | 19 | 0 | 0 | 242 |
| 360d | 2025-09-22 | 12 | 249 | 21 | 0 | 0 | 482 |
| last720d | 2024-09-27 | 30 | 581 | 25 | 0 | 0 | 1026 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/mongosh.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260917.yml` · 2026-09-17T04:43:33Z._
