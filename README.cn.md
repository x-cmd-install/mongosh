...
[![x-cmd/install — mongosh Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/mongosh.svg?lang=zh)](https://x-cmd.com/install/mongosh)
...
合计: **179,761** 行代码（覆盖前 5 种语言、共 **761** 个文件）。
...
- **Star**: 402 · **Fork**: 93 · **开放 issue**: 0 · **贡献者**: 78

## 累计统计

- **发布数**: 151 · **已合并 PR**: 2659 · **开放 PR**: 25 · **已关闭 issue**: 0 · **开放 issue**: 0 · **提交数**: 4554
...
_数据快照: `data/card/260923.yml` · 2026-09-23T04:35:02Z._
